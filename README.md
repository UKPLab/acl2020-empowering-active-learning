...
The model will then be updated on the newly scored sample and used to sample the next C-Test.
The implementation includes a total of five different learner models, five different sampling strategies, and four different learner behaviours. 
